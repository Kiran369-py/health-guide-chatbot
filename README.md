...
Let’s create a retrieval based chatbot using NLTK, Keras, Tensorflow, Python, etc.
Download Chatbot Dataset
...
documents = []
ignore_words = ['?', '!']
data_file = open('C:\\Users\layak\OneDrive\Desktop\chat_bot\intents.json').read()
...
import json
import random
intents = json.loads(open('C:\\Users\layak\OneDrive\Desktop\chat_bot\intents.json').read())
